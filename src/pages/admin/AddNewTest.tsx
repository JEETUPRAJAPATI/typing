      ...
      <form className="space-y-4">
        <div className="grid gap-4 xl:grid-cols-2">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-card">
            ...
            <div className="grid gap-3.5 lg:grid-cols-[150px_1fr_1fr_150px]">
              <label className="block">
                <span className="mb-1.5 block text-[12px] font-semibold text-navy-800">
              ...
              <div>
                <p className="mb-1.5 text-[12px] font-semibold text-navy-800">
                  Upload Text File <span className="text-danger">*</span>
                </p>
                <button
                  type="button"
                  className="flex h-[132px] w-full flex-col items-center justify-center gap-2 rounded-md border-2 border-dashed border-slate-300 px-3 text-center transition-colors duration-150 hover:border-primary hover:bg-primary-50/40">
                  
                  <FileTextIcon className="h-7 w-7 text-primary" aria-hidden="true" />
                  <span className="text-[11.5px] text-slate-600">
                    Click to upload or drag &amp; drop
                  </span>
                  <span className="text-[10.5px] text-slate-400">
                    TXT, DOCX, PDF files supported (Max size: 10 MB)
                  </span>
                </button>
              </div>
              ...
              <div>
                <p className="mb-1.5 text-[12px] font-semibold text-navy-800">
                  Upload Auto File (Steno) <span className="text-danger">*</span>
                </p>
                <button
                  type="button"
                  className="flex h-[132px] w-full flex-col items-center justify-center gap-2 rounded-md border-2 border-dashed border-slate-300 px-3 text-center transition-colors duration-150 hover:border-primary hover:bg-primary-50/40">
                  
                  <MicIcon className="h-7 w-7 text-violet-600" aria-hidden="true" />
                  <span className="text-[11.5px] text-slate-600">
                    Click to upload or drag &amp; drop
                  </span>
                  <span className="text-[10.5px] text-slate-400">
                    AUDIO, MP3, WAV files supported (Max size: 20 MB)
                  </span>
                </button>
              </div>
